...
> **Also install the integration:** [overseerr-hacs](https://github.com/berserk88/overseerr-hacs) — **required** for the card to function.
...
- The [Overseerr integration](https://github.com/berserk88/overseerr-hacs) installed and configured
